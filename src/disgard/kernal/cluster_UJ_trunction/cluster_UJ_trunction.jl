...
function Kernel_UJ(
	...
	return Kernel_UJ(Kᵈ_U, Kᵈ_J¹, Kᵈ_J², Kˣ_U, Kˣ_J¹, Kˣ_J²; kwards...)
end
"""
...
function Kernel_UJ(
	...
	if isnothing(upindex)
		if isnothing(dnindex)
			return _cluster_spinless_UJ_Kernel(W, V)
		else
	...
	return _cluster_time_reversal_UJ_Kernel(upindex, dnindex, W, V)
end

function (K::Union{_cluster_spinless_UJ_Kernel, _cluster_time_reversal_UJ_Kernel})(::Val{:initialize})
