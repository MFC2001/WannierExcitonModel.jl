...
struct _uijR_ψvck_spinless{Tt, Ts, St, Ss}
	Nvck::Int
	NijR::Int
	vckmap::vckMap
	ijRmap::ijRMap
...
function (ijRvck::_uijR_ψvck_spinless)(bandk, bandkq, q)
...
struct _uijR_ψvck_spinless_sameη{T <: Real, S <: Real}
	Nvck::Int
	NijR::Int
	vckmap::vckMap
	ijRmap::ijRMap
...
function (ijRvck::_uijR_ψvck_spinless_sameη)(bandk, bandkq, q)
...
struct _uijR_ψvck_spinful{T <: Real, S <: Real}
	Nvck::Int
	NijR::Int
	vckmap::vckMap
	ijRmap::ijRMap
