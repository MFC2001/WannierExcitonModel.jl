...
"""
function Kernal_UJ(kgrid::RedKgrid,
	Kᵈ_U::UwithLR{UT_d, CT_d}, Kᵈ_J¹::ReciprocalHoppings{J¹T_d}, Kᵈ_J²::ReciprocalHoppings{J²T_d},
	Kˣ_U::UwithLR{UT_x, CT_x}, Kˣ_J¹::ReciprocalHoppings{J¹T_x}, Kˣ_J²::ReciprocalHoppings{J²T_x};
	...
	W = _spinless_UJ_Kᵈ(Kᵈ_U, Kᵈ_J¹, Kᵈ_J², Kᵈ_Uk, Kᵈ_J¹q, Kᵈ_J²kq)
	...
	V = _spinless_UJ_Kˣ(Kˣ_U, Kˣ_J¹, Kˣ_J², Kˣ_Uq, Kˣ_J¹k, Kˣ_J²kq)
...
function (K::Union{_spinless_UJ_Kernal, _time_reversal_UJ_Kernal})(::Val{:initialize_qgrid})
	Threads.@threads for k in Base.OneTo(K.nk)
		K.W.J²(K.W.J²kq[k], K.kgrid_Γ[k])
		K.W.J²kq[k] ./= K.nk
	end
	Threads.@threads for k in Base.OneTo(K.nk)
		K.V.J²(K.V.J²kq[k], K.kgrid_Γ[k])
		K.V.J²kq[k] ./= K.nk
	end
	return nothing
end
function (K::Union{_spinless_UJ_Kernal, _time_reversal_UJ_Kernal})(kq_kindex::Vector{Int}, kΓq_kΓindex::Vector{Int}, q::ReducedCoordinates)
	...
	K.J¹q ./= K.nk
	#WJ²(k_Γ+q)
	permute!(K.W.J²kq, kΓq_kΓindex)
	#VU(q)
	K.V.U(K.V.Uq, q)
	K.V.Uq ./= K.nk
	#VJ²(k_Γ+q)
	permute!(K.V.J²kq, kΓq_kΓindex)
	return nothing
end
